  ...
  >
    ...
    <div class="settings-dropdown__content pl-4 pr-4 pt-2 pb-2">
      ...
      <va-button-toggle
        ...
        small
      />
      <!--<router-link to="parametres"><b-button variant="danger">Parametres</b-button></router-link>-->
    </div>
  </va-dropdown>
</template>
...
export default {
  ...
  data () {
    return {
      options: [
        { label: 'vertical', value: String(false) }, // NOTE: boolean is unsupported for va-dropdown
        { label: 'horizontal', value: String(true) },
      ],
    }
  },
  computed: {
